...
public class LinearProbingHashTable<K> implements HashTable<K> {
  ...
  public static <K> LinearProbingHashTable<K> copyOf(HashTable<K> that) {
    LinearProbingHashTable<K> newHashTable = LinearProbingHashTable.withCapacity(that.size());
      for (K key : that) {
  ...
  public K search(K key) {
    int indexFound = searchIndex(key);
